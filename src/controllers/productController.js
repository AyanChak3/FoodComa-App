...
async function addProduct(req,res){
    try{
        const product = await createProduct({
            ...
            category : req.body.category, //if category is undefined, veg will be stored due to default value
            inStock : req.body.inStock //if inStock is undefined, then true will be stored due to default value
        })
